...
from apps.recommend.models import JpaItems, JpaStores
                ...
                for community in temp_list:
                    data_json = {
                        ...
                        "item": {
                            ...
                            "retailPrice": float(community.item.original_price),
                            "activityPrice": float(community.item.discount_price),
