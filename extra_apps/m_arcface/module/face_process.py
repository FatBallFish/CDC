...
from extra_apps.m_arcface.arcface import ArcFace, image_regularization, Rect
from extra_apps.m_arcface.arcface import FaceInfo as ArcFaceInfo
from extra_apps.m_arcface.arcface import Gender
from extra_apps.m_arcface.module.image_source import get_regular_file, read_image
...
class FaceProcess:
    ...
    def reload_features(self, db: int = -1, user: JpaUsers = None) -> int:
        """
