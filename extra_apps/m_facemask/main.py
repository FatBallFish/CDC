...
from extra_apps.m_facemask.utils.anchor_generator import generate_anchors
from extra_apps.m_facemask.utils.anchor_decode import decode_bbox
from extra_apps.m_facemask.utils.nms import single_class_non_max_suppression
from extra_apps.m_facemask.load_model.pytorch_loader import load_pytorch_model, pytorch_inference
...
ImgCaptcha 模块初始化，此函数应在所有函数之前调用
    ...
    model_path = os.path.join(Main_filepath, "extra_apps", "m_facemask", "models", "face_mask_detection.pth")
    # print(model_path)
